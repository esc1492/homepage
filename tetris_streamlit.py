...
st.markdown("""
<style>
#stDecoration, .stAppDeployButton, footer { display: none !important; }
...
body { background: #111; color: #eee; font-family: monospace; display: flex; justify-content: center; padding: 30px 0 0; }
